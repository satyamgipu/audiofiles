# -*- coding: utf-8 -*-
"""
Created on Tue Jul 16 11:21:02 2019
...
def conversion(path):
    ...
    if path=="/home/tatras/Downloads/genres/genres/pop/*.au":
      for i in z:
        music_mp3=[]
        tfm.build(i, '/home/tatras/Downloads/pop/pop'+str(n)+'.wav')
     ...
     # print(music_pop)
      ...
      for i in z:
        ...
        music_classical.insert(n,"/home/tatras/Downloads/classical/classical"+str(n)+".wav")
        n=n+1
        #print(mp3)
        #music_mp3=music_mp3+mp3
